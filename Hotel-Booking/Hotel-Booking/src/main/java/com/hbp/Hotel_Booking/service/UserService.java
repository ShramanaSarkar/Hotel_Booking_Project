...
public class UserService {
	...
	public ResponseEntity<ResponseStructure<User>> findByUserId(int userId){
		...
		if(dbUser!=null) {
			...
			throw new AddressIdNotFoundException("User id not found");
		}
	}
	
	public ResponseEntity<ResponseStructure<User>> updateHotel(UserDto userDto, int userId){
		User user=modelMapper.map(userDto, User.class);
	...
	public ResponseEntity<ResponseStructure<User>> deleteUser(int userId){
		...
		if(dbUser!=null) {
			...
			throw new AddressIdNotFoundException("User not found");
		}
	}
